...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    if (UIInterfaceOrientationIsLandscape(orientation))
    {
        if(UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPad)
        {
            ...
            [panelView setFrame:CGRectMake(10,10,1024-20, 768-20)];
            [containerView setFrame:CGRectMake(20, 20, 1024-60, 768-60)];
            [webView setFrame:CGRectMake(0,0, 1024-60, 768-60)];
            [indicatorView setCenter:CGPointMake(1024/2,768/2)];
        ...
        else 
        {
            ...
            [panelView setFrame:CGRectMake(10, 10, 460, 300)];
            [containerView setFrame:CGRectMake(10, 10, 440, 280)];
            [webView setFrame:CGRectMake(0,0, 440, 280)];
    ...
    else
    {
        if(UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPad)
        {
            ...
            [panelView setFrame:CGRectMake(10,10,768-20, 1024-20)];
            [containerView setFrame:CGRectMake(20, 20,768-60,1024-60)];
            [webView setFrame:CGRectMake(0,0, 768-60, 1024-60)];
            [indicatorView setCenter:CGPointMake(1024/2,768/2)];
    ...
    [self setCenter:CGPointMake(p, n)];
