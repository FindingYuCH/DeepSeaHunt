...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    {
        [self setFrame:CGRectMake(0, 0, screenFrame.size.height, screenFrame.size.width)];
        [panelView setFrame:CGRectMake((screenFrame.size.height-480)/2+16,(screenFrame.size.width-320)/2+10, 480 - 32, 280)];
    ...
    else
    {
        ...
        [panelView setFrame:CGRectMake((screenFrame.size.width-320)/2+16,(screenFrame.size.height-480)/2+ 73 - 10, 288, 335)];
